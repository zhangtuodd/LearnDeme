...
public class Record2Activity extends AppCompatActivity implements SurfaceHolder.Callback , SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (mCamera != null && mCameraID == Camera.CameraInfo.CAMERA_FACING_BACK){
                    mCamera.autoFocus(new Camera.AutoFocusCallback() {
                        ...
                        public void onAutoFocus(boolean success, Camera camera) {
                            if(success){
                                Toast.makeText(Record2Activity.this,"对焦成功",Toast.LENGTH_SHORT).show();
                            }else{
        ...
        mSensorManager = (SensorManager) Record2Activity.this.getSystemService(Activity.SENSOR_SERVICE);
    ...
    public void init(){
        if(mSurfaceView == null){
            ...
            WindowManager wm = (WindowManager) Record2Activity.this.getSystemService(Context.WINDOW_SERVICE);
    ...
    private void initCamera() {
        ...
        if (mCamera != null){
            ...
            int degree = calculateCameraPreviewOrientation(Record2Activity.this);
    ...
    private  void handleFocus(MotionEvent event, Camera camera) {
        ...
        camera.autoFocus(new Camera.AutoFocusCallback() {
            ...
            public void onAutoFocus(boolean success, Camera camera) {
                ...
                camera.setParameters(params);
                if(success){
                    Toast.makeText(Record2Activity.this,"对焦区域对焦成功",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
