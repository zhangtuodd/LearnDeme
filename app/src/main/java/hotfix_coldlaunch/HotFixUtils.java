...
public class HotFixUtils {
     ...
     * 处理dex替换，完成修复
     *
     * @https://blog.csdn.net/huideveloper/article/details/105924820
     *
     * 修复的dex如何找到，编译完 文件搜索"类名.dex"
    ...
    public static void fixBug(Context context) {
        ...
        //targetFilePath:/data/user/0/com.example.zhangtuo.learndeme/app_hui_patch/patch.apk
        String assetFileName = "HotFixActivity.dex";
